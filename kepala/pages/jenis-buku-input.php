<div id="label-page"><h3>Input Data Jenis Buku</h3></div>
<div id="content">
	<form action="../admin/proses/jenis-buku-input-proses.php" method="post">
	<table id="tabel-input">
		...
		<tr>
			<td class="label-formulir">Jenis Buku</td>
			<td class="isian-formulir"><input type="text" name="jenis_buku" class="isian-formulir isian-formulir-border"></td>
		</tr>
		<tr>
