...
?>
<div id="label-page"><h3>Tampil Data Denda</h3> <form action="cari/cari_buku.php" method="get">
...
<div id="content">
	...
	<table id="tabel-tampil">
		...
		<?php
		$q_tampil_buku=mysql_query("SELECT * from tbl_denda ORDER BY id_denda ASC")or die(mysql_error());
		$nomor=1;
		while($r_tampil_buku=mysql_fetch_array($q_tampil_buku)){
		?>
		<tr>
			<td><?php echo $nomor++; ?></td>
			<td><?php echo $r_tampil_buku['id_denda']; ?></td>
			<td><?php echo $r_tampil_buku['kode_denda']; ?></td>
			<td><?php echo $r_tampil_buku['jenis_denda']; ?></td>
			<td><?php echo $r_tampil_buku['nama']; ?></td>
			<td><?php echo $r_tampil_buku['jurusan']; ?></td>
			<td><?php echo $r_tampil_buku['tarif_denda']; ?></td>
			<td>
