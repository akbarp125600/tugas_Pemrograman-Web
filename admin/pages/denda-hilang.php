...
?>
<div id="label-page"><h3>Tampil Data Denda Hilang</h3> <form action="cari/cari_buku.php" method="get">
...
<div id="content">
	...
	<table id="tabel-tampil">
		...
		<?php
		$q_tampil_buku=mysql_query("SELECT * from tbl_pengembalian where keterangan='Hilang' ORDER BY id_pengembalian ASC")or die(mysql_error());
		$nomor=1;
