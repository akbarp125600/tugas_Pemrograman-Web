	...
	<div id="container">
		<div id="header">
			...
			<div id="nama-alamat-perpustakaan-container">
				...
				<div class="pencarian"><a> <?php date_default_timezone_set('Asia/Jakarta');
												 echo date('d-m-Y H:i:s');?> </a></div>
			</div>
		</div>
		<div id="header2">
		...
		<div id="sidebar">
			...
			<p class="label-navigasi">Entry Data</p>
			<ul>
				...
				<li><a href="index.php?p=jenis_buku">Data Jenis Buku</a></li>
				<li><a href="index.php?p=bidang_buku">Data Bidang Buku</a></li>
			</ul>
			<p class="label-navigasi">Transaksi</p>
			<ul>
				<li><a href="index.php?p=data_peminjaman">Data Peminjam</a></li>
				<li><a href="index.php?p=data_pengembalian">Data Pengembalian</a></li>	
			</ul>
			<p class="label-navigasi">Data Denda</p>
			<ul>
				<li><a href="index.php?p=denda">Data Denda Terlambat</a></li>
				<li><a href="index.php?p=denda-rusak">Data Denda Rusak</a></li>
				<li><a href="index.php?p=denda-hilang">Data Denda Hilang</a></li>
			</ul>
