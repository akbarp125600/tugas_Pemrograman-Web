...
<div id="content">
	<p id="tombol-tambah-container"><a href="index.php?p=pengembalian-input2" class="tombol">pengembalian</a>
	</p>
	...
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td><?php echo $r_data_peminjaman['keterangan']; ?></td>
			<td><?php echo $r_data_peminjaman['denda_telat']; ?></td>
			<td><?php echo $r_data_peminjaman['denda_buku']; ?></td>
			<td><?php echo $r_data_peminjaman['total_denda']; ?></td>
			<td>
